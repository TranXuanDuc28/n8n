...
module.exports = (sequelize) => {
  const ModerationLog = sequelize.define('ModerationLog', {
    ...
    comment_id: { type: DataTypes.STRING(100), allowNull: false },
    action: { type: DataTypes.ENUM('hide','delete','restore','manual_review'), allowNull: false },
    reason: { type: DataTypes.STRING(255), allowNull: true },
    performed_by: { type: DataTypes.STRING(50), defaultValue: 'system' },
