...
module.exports = (sequelize) => {
  ...
  Engagement.associate = (models) => {
    ...
    Engagement.belongsTo(models.Post, { foreignKey: 'post_id', targetKey: 'id', as: 'post' });
    // Engagement belongs to a PlatformPost (by platform_post_id)
    Engagement.belongsTo(models.PlatformPost, { foreignKey: 'platform_post_id', targetKey: 'platform_post_id', as: 'platformPost' });
  };
