...
class ModerationController {
  ...
  static async hideComment(req, res) {
    try {
      ...
      Logger.error('HideComment error', {
        error: error.message
      });
      res.status(500).json({
        success: false,
  ...
  static async restoreComment(req, res) {
    try {
      ...
      Logger.error('RestoreComment error', {
        error: error.message
      });
      res.status(500).json({
        success: false,
  ...
  static async batchModerate(req, res) {
    try {
      ...
      Logger.error('BatchModerate error', {
        error: error.message
      });
      res.status(500).json({
        success: false,
  ...
  static async getToxicForReview(req, res) {
    try {
      ...
      Logger.error('GetToxicForReview error', {
        error: error.message
      });
      res.status(500).json({
        success: false,
