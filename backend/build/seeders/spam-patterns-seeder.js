...
// Keywords spam
{
  ...
  pattern_type: 'keyword',
  pattern_value: 'liên hệ ngay',
  description: 'Từ spam phổ biến'
}, {
  pattern_type: 'keyword',
  pattern_value: 'giảm giá sốc',
  description: 'Từ spam phổ biến'
}, {
  pattern_type: 'keyword',
  pattern_value: 'miễn phí',
  description: 'Từ spam phổ biến'
}, {
  pattern_type: 'keyword',
  pattern_value: 'khuyến mãi khủng',
  description: 'Từ spam phổ biến'
},
// Regex patterns
{
  pattern_type: 'regex',
  pattern_value: '\\d{10,11}',
  description: 'Số điện thoại 10-11 số'
}, {
  pattern_type: 'regex',
  pattern_value: '(http|https)://[^\\s]+',
  description: 'URL links'
}, {
  pattern_type: 'regex',
  pattern_value: '@[a-zA-Z0-9_]+',
  description: 'Mention tags'
},
// Domains
{
  pattern_type: 'domain',
  pattern_value: 'bit.ly',
  description: 'Shortened URL'
}, {
  pattern_type: 'domain',
  pattern_value: 'tinyurl.com',
  description: 'Shortened URL'
}, {
  pattern_type: 'domain',
  pattern_value: 'shopee.vn',
  description: 'Competitor link'
}, {
  pattern_type: 'domain',
  pattern_value: 'lazada.vn',
  description: 'Competitor link'
},
// Phone patterns
{
